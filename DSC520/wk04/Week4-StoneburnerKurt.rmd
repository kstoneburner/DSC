...
round( cor(survey_df$TimeReading,survey_df$TimeTV, method="kendall")^2 *100,2 )
```
...
I believe, the more time spent watching decreases the likelihood that a student will spend time reading.
