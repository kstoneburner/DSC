...
##########################################################################################################
#### The data for this report has already been processed. I'm keeping these functions here for         ###
#### Completeness. This is a current an ongoing data set, it is updated daily.                         ###
##########################################################################################################
...
##########################################################################################################
  ...
  #################################################################################################################################
  ### Coefficients and Intercepts are commented out since i'm not accurately reassembling the values frome the county models.
  ### This is high on my priority list and is essential to calculating estimated Case Fatatlity, Hospitalization and ICU rates,
  #################################################################################################################################
