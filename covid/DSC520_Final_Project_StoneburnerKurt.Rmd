...
I suspect the issue lies in differing scales. A confirmed case and a death are only counted once each. Hospitalization and ICU care involve multi-day stays before patients recover or die. Being counted once, for confirmed or death vs multiple days in the hospital is a problem of scale and makes the values difficult to compare. It would be interesting to find active case
